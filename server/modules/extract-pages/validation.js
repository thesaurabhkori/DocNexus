/**
 * Middleware to validate incoming file and page range parameters for page extraction.
 */
export const validateExtractPages = (req, res, next) => {
  if (!req.files || req.files.length === 0) {
    return res.status(400).json({
      success: false,
      message: "Processing payload error: No file detected for page extraction."
    });
  }
  ...
  // Validate pages parameter format if provided
